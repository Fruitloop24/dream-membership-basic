...
You are helping add PWA support to this React + Vite membership template. This will make the app installable on phones and tablets.
...
Ask: **"What's your membership site name?"** - Use it for `name` and `short_name` (short_name max 12 chars)
...
Ask: **"What's your deployed URL? (e.g., https://mymembership.pages.dev)"**
...
"Your membership site is now installable as a PWA with a QR code! Members can:

- **Scan the QR** - Opens your site instantly
...
Members scan → Install → Done. No app store fees, no review process!"
